...
if(!empty($_POST)){
	...
	$employe->setmatricule($_POST['Matricule']);
                                         ...
                                         <div class="row">
                                            <div class="col-6" style="width :100% ;">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-exp" name="Matricule" type="number" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                                                            data-val-cc-exp="Please enter a valid month and year" placeholder="matricule"
                                                            autocomplete="cc-exp">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-exp" name="Prenom" type="text" class="form-control cc-exp" value="" data-val="true" data-val-required="Please enter the card expiration"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="x_card_code" name="Nom" type="text" class="form-control cc-cvc" value="" data-val="true" data-val-required="Please enter the security code"
                                                            data-val-cc-cvc="Please enter a valid security code" autocomplete="off"placeholder="nom">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="cc-pament" name="Date_de_naissance" type="date" class="form-control" aria-required="true" aria-invalid="false" value="100.00">
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="cc-name" class="control-label mb-1">Departemant</label>
                                                <input id="cc-name" name="Departement" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                                                    autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error"placeholder="department">
